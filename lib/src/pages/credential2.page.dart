...
class Credential2Page extends StatelessWidget {
  static final String routeName = 'credential2';
  ...
  generateCredencial(context) {
    ...
    TextStyle styletext = TextStyle(fontSize: 23, color: Color.fromRGBO(8, 54, 130, 1.0));
    if (_prefs.imagen != "") {
  ...
  generateQr(Size size) {
    final value = _prefs.identificacion;
