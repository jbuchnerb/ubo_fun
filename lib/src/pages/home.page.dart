...
class HomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    body: Container(
        ...
        decoration: BoxDecoration(
            image: DecorationImage(image: AssetImage("assets/img/fondo-appv6.png"), fit: BoxFit.fill)),
        child: Table(
  ...
  children: <Widget>[
    ...
    Container(
      padding: const EdgeInsets.all(3),
      child: _crearBotonRedondeado(bluecolor, Icons.directions_car_outlined,
              'Patentes', /*NewsPage.routeName*/'', context),
      color: Colors.transparent,
    ),
                          ...
                          Container(
                                  ...
                                  decoration: new BoxDecoration(
                                    ...
                                    image: new DecorationImage(
                                        fit: BoxFit.fill,
                                        image: Image.asset("assets/img/logo_ubo_white.png").image
                                    )
                                )),
                            SizedBox(
           ...
           //height: 180.0,
            ...
            child: Column(
              ...
              children: <Widget>[
                //SizedBox(height: 5.0),
                CircleAvatar(
                  backgroundColor: Colors.transparent,//Color.fromRGBO(66, 129, 237, 0.2),//color,
                  radius: size.height * 0.030,
                  child: Icon(icono, color: Colors.white, size: size.height * 0.07),
                ),
                Text(texto,
                    textAlign: TextAlign.center,
                    style:
                        TextStyle(color: Colors.white/*color*/, fontWeight: FontWeight.bold)),
                //SizedBox(height: 5.0)
              ],
            ),
          ),
